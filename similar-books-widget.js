...
(function () {
  ...
  function injectStyles() {
    ...
    style.id = "sb-styles";
    style.textContent = `
      .sb-layout { display: grid; grid-template-columns: 1fr 336px; gap: 1.6rem;
      ...
      .sb-panel { background: var(--white, #fff); border: 1px solid var(--light-line, #D0E4F5);
        border-radius: 16px; box-shadow: var(--card-shadow, 0 4px 24px rgba(0,100,180,.09));
      ...
      .sb-panel-head { background: linear-gradient(135deg, var(--dark-blue-2, #0D1F3C), #112040);
        padding: 1.1rem 1.3rem; border-bottom: 2px solid var(--cyan, #00B4D8);
        display: flex; align-items: center; gap: .6rem; }
      .sb-panel-head i { color: var(--cyan, #00B4D8); font-size: .95rem; }
      .sb-panel-title { font-family: 'Playfair Display', serif; font-size: 1rem; font-weight: 700;
        color: #fff; line-height: 1.3; }
      .sb-panel-sub { font-size: .66rem; letter-spacing: .1em; text-transform: uppercase;
        color: var(--cyan-light, #48CAE4); margin-top: .15rem; font-weight: 600; }

      .sb-list { display: flex; flex-direction: column; }
      .sb-item { display: flex; gap: .8rem; padding: .9rem 1.2rem; border-bottom: 1px solid var(--light-line, #D0E4F5);
      ...
      .sb-cover-wrap { flex-shrink: 0; width: 46px; height: 62px; border-radius: 5px; overflow: hidden;
      ...
      .sb-cover-wrap i { color: var(--cyan, #00B4D8); font-size: 1rem; }
      .sb-item-body { flex: 1; min-width: 0; display: flex; flex-direction: column; gap: .25rem; }
      .sb-reason { display: inline-flex; align-items: center; gap: .3rem; font-size: .58rem;
        letter-spacing: .08em; text-transform: uppercase; font-weight: 700; color: var(--medium-blue, #1A4B8C);
        width: fit-content; }
      .sb-reason i { font-size: .58rem; color: var(--cyan, #00B4D8); }
      .sb-item-title { font-family: 'Playfair Display', serif; font-size: .84rem; font-weight: 600;
        color: var(--dark-blue, #0A1628); line-height: 1.3; }
      .sb-item-author { font-size: .7rem; color: var(--muted, #6B8CAE); font-style: italic; }
      .sb-item-link { font-size: .66rem; font-weight: 700; color: var(--cyan, #00B4D8);
        margin-top: .1rem; display: inline-flex; align-items: center; gap: .25rem; }
